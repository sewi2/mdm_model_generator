...
class TestModelGeneratorJsonStringNotFormattedField(ModelGeneratorMixin):
    schema: dict = SCHEMA
    ...
    def test_result_definition(self):
        assert self._result_definition == (
            "models.JSONField(verbose_name='Oidp codes', "
...
class TestSerializerGeneratorJsonStringNotFormattedField(
    ...
    def test_result_definition(self):
        assert self._result_definition == (
            "serializers.JSONField(label=_('Коды ОИДП'), "
            "help_text='Oidp codes', "
