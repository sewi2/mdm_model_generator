...
class BaseBenchmarkCatalogObjectTable(BasePHistorical):
    ...
    class Meta:
        ...
        abstract = True
        db_table = 'BenchmarkCatalogObjectTable' if getattr(settings, 'MDM_MODELS_CAMEL_CASE', False) else None
